...
export const Input = ({ Class, PlaceHolder, Type, Value, Name, onChange, Id }) => <input className={Class} placeholder={PlaceHolder} value={Value} onChange={onChange} type={Type} name={Name} id={Id} ></input>
